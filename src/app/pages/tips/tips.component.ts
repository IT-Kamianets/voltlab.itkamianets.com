	...
	tips: Tip[] = [
		{
			...
			content:
				'<p><strong>Ват (W)</strong> — це швидкість, з якою прилад "їсть" енергію (як швидкість авто).</p><p><strong>Ват-година (Wh)</strong> — це об\'єм спожитої енергії за певний час (як кількість літрів бензину в баку).</p>',
		},
		{
			category: '⚡ Базові поняття',
			title: 'Закон Ома (простий трикутник)',
			content:
				'<p>Як знайти потужність: <strong>W = V × A</strong></p><p>Наприклад, потужність роутера "12V 1.5A": 12 × 1.5 = 18 Вт.</p>',
		},
		{
			category: '🔋 Батареї, станції та інвертори',
			title: 'Чому станція віддає не всю ємність?',
			content:
				'<p>Справа у <strong>ККД інвертора</strong>. На перетворення струму з батареї у розетку 220V витрачається 10-15% енергії.</p>',
		},
		{
			category: '🔋 Батареї, станції та інвертори',
			title: 'AC vs DC: що вигідніше?',
			content:
				'<p>Заряджати телефон через USB (DC) від станції вигідніше, оскільки ви уникаєте зайвих втрат на подвійне перетворення струму.</p>',
		},
		{
			category: '🏠 Побутова техніка',
			title: 'Приховані "пожирачі" енергії',
			content:
				'<p>Найбільше навантаження дають прилади з нагрівальними елементами. Наприклад, нагрів води і сушка у пральній машині створюють пікове навантаження понад 2000 Вт.</p>',
		},
		{
			category: '☀️ Сонячна енергія',
			title: 'Що таке інсоляція?',
			content:
				'<p>Це кількість сонячних променів, які досягають поверхні. Тому панель на 100 Вт не видає 100 Вт у похмуру погоду.</p>',
		},
	];
